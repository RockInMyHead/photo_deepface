# app.py — Face Sorter (no DnD)
# Safe ops + audit + run history + LAN URL picker; Drag&Drop полностью удалён.
...
st.set_page_config(page_title="Face Sorter — Мини-проводник (no DnD)", layout="wide")
...
st.title("Face Sorter — Мини-проводник (no DnD)")
